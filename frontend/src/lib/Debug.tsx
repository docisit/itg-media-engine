...
export const useDebugMode = ({ logLevel }: { logLevel?: LogLevel }) => {
  ...
  React.useEffect(() => {
    ...
    if (process.env.NEXT_PUBLIC_DATADOG_CLIENT_TOKEN && process.env.NEXT_PUBLIC_DATADOG_SITE) {
      console.log('Datadog logging would be enabled here if @datadog/browser-logs was installed');
      // Note: Datadog logging is disabled due to missing dependency
      // To enable, install: npm install @datadog/browser-logs
    }
