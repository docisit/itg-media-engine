...
export async function POST(request: NextRequest) {
  console.log(">>> INGRESS_ROUTE_STARTED");
  ...
  try {
    ...
    console.log(`>>> PROXYING_TO_BACKEND: ${backendUrl}/api/webrtc/ingress/`);
    console.log(`>>> REQUEST_BODY:`, JSON.stringify(body));

    const response = await fetch(`${backendUrl}/api/webrtc/ingress/`, {
      method: 'POST',
      headers: {
